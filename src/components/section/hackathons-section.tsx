        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              While Learning i've thought to contribute to Open Source Projects
              which eventually taught me a lot Currently i've contributed to{" "}
              {DATA.hackathons.length} projects and thinking to contribute more
            </p>
          </div>
        </div>
        <Timeline>
          {DATA.hackathons.map((hackathon) => (
            <TimelineItem
              ...
              className="w-full flex items-start justify-between gap-10 group/hackathon">
              ...
              <div className="flex flex-1 flex-col justify-start gap-2 min-w-0">
                ...
                {hackathon.title && (
                  <a
                    ...
                    <ArrowUpRight
                      className="h-3.5 w-3.5 text-muted-foreground transition-all duration-200"
                      aria-hidden
                    />
                  </a>
                )}
                  ...
                  <div className="mt-2 flex flex-col gap-2 w-full">
                    ...
                    <motion.div
                      ...
                      <div className="flex items-center gap-2 cursor-pointer w-fit group-hover/collapsible:text-primary transition-colors py-1">
                        <span className="text-xs font-medium text-muted-foreground group-hover/collapsible:text-foreground">
                          View Contributions
                        </span>
                          ...
                          {hackathon.links.map((link, idx) => {
                            ...
                            return (
                              <div
                                ...
                                <span
                                  className="absolute size-1.5 rounded-full bg-muted/40 group-hover/link:bg-primary/50 transition-colors"
                                  style={{
                                    left: `-${offset + 16}px`,
                                    top: "50%",
