...
export const DATA = {
  ...
  description: "Full-stack Engineer | Web3 & Blockchain Enthusiast. ",
  summary:
    "I am Dhruva Maheshwari, a BTech student currently in my 6th semester. While placement season is approaching, my focus has shifted from just 'studying' to building software that actually works in production. Over the last 8 months, I’ve moved beyond the basics to master the full lifecycle of an application.",
  avatarUrl: "/me.png",
  skills: [
  ...
  education: [
    {
      ...
      currentSem: "Current Semester: 6th Sem",
      marks: "CGPA 7.46",
    },
    {
      school: "Maharishi Arvind Public School, Kota",
      href: "https://www.maharishiarvindschool.org/intro.htm",
      degree: "12th Grade / HSC (CBSE - Science)",
      logoUrl: "/school.png",
      start: "2021",
      end: "2022",
    },
  ...
  projects: [
    {
      title: "DMX Wallet",
      href: "https://dmx-wallet.vercel.app/",
      dates: "Jan 2026 – Feb 2026",
      active: true,
      description:
        "A lightweight Solana-based crypto wallet that generates public/private keys and a mnemonic locally. Users can import wallets using a seed phrase to recover keys and securely delete wallet data. Built client-side with no backend, ensuring full user control and privacy.",
      technologies: [
        "React",
        "Vite",
        "Tailwind CSS",
    ...
    {
      title: "RailCoach Management System",
      href: "https://github.com/Dhruvamaheshwari/Coach-Management-System",
  ...
  hackathons: [
    {
      title: "Kana Dojo",
      website: "https://kanadojo.com",
      dates: "November 14, 2025",
      repository: "lingdojo/kana-dojo",
      repoUrl: "https://github.com/lingdojo/kana-dojo",
      description:
        "A web app that helps you learn Japanese by providing interactive lessons and exercises.",
      image: "https://avatars.githubusercontent.com/u/240290321?s=200&v=4",
